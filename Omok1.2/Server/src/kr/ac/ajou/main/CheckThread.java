...
public class CheckThread extends Thread {
      ...
      if (!protocolQueue.isEmpty()) {
        ...
        switch (type) {
          case ConstantProtocol.LOGIN:
            ...
            System.out.println(mainState.getId());
            System.out.println(clientCount);
            userListMap.put(mainState.getId(), clientCount);
            sendToSessionsUserListMap();
  ...
  private void sendToSessionsUserListMap() {

    Gson gson = new Gson();
    userList = new UserList(userListMap);
